...
import com.ufms.nes.features.template.viewmodel.AddModelUiState
import com.ufms.nes.features.template.viewmodel.QuestionModelUiState
    ...
    Column(
        ...
        if (uiState.value.questionsIsEmpty) {
            Text(
                ...
                text = stringResource(id = R.string.add_unit_question),
                color = MaterialTheme.colorScheme.error
            )
        }
